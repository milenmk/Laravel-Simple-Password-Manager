 ...
 * @method $this storedAs(string|Expression $expression) Create a stored generated column (MySQL/PostgreSQL/SQLite)
 ...
 * @method $this virtualAs(string|Expression $expression) Create a virtual generated column (MySQL/PostgreSQL/SQLite)
 */
