        ...
        <tr class="<?=($c++%2==1) ? 'odd' : 'even' ?> border-b">
            ...
            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                <button type="submit"
                    ...
                    <a href="{{ $record->id }}/edit_record" class="bg-blue-500 p-2 text-white hover:shadow-lg text-xs font-thin">{{ __('Edit') }}</a>
                </button>
                <button type="submit"
                    ...
                    <a href="{{ $record->id }}/delete_record" class="bg-red-500 p-2 text-white hover:shadow-lg text-xs font-thin">{{ __('Delete') }}</a>
                </button>
            </td>
        </tr>
    @endforeach
