...
@foreach ($domains as $domain)
    <tr class="<?=($c++%2==1) ? 'odd' : 'even' ?> border-b">
        ...
        <td class="text-sm text-gray-900 font-light px-2 py-4 whitespace-nowrap">
            ...
            <div class="inline-flex items-center px-2 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest
